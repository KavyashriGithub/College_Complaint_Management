            ...
            <div className="col-lg-10 offset-lg-1">
              <div className="contact_form_container py-5">
                <div className="contact_form_title">
                  <h2 className='text-center'id='text-center'>File a Complaint</h2>
                </div>
...
<br />
                  <label for="complaint">Choose a department:</label>
                    ...
                    <option value="">--Select department--</option>
                     <option value="Academic Grievances">Academic Grievances</option>
                     <option value="Administrative and facility Issues">Administrative and facility Issues</option>
                     <option value="Harassment and Discrimination">Harassment and Discrimination</option>
                     <option value="Financial and Admission Issues">Financial and Admission Issues</option>
...
<br />
                  <div className="contact_form_button">
                    ...
                    onClick={fileGrievance}>Submit Complaint</button>
                  </div>
                </form>
              </div>
            </div>
...
<div className="col-1"></div>
             ...
             <div className="contact_info_item col-3 abc">
               <h6>Email</h6>
               <p>kavyasudarshanamap@gmail.com</p>
             </div>
...
<div className="col-1"></div>
             ...
             <div className="contact_info_item col-2 abc">
               <h6>Address</h6>
               <p>PB.NO. 3417, 3rd Block, 8th Main,Koramangala Bengaluru - 560034</p>
             </div>
